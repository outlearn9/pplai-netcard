  ...
  return (
    <>
      ...
      <nav className="auth-nav">
        ...
        <a href="/sign-up" style={{ fontSize: 14, fontWeight: 600, color: '#6366F1', textDecoration: 'none' }}>
          Create free account →
        </a>
      </nav>
      ...
      <main className="auth-page">
        <div className="auth-wrap">
          <div className="auth-brand">
            <p className="auth-tagline">Welcome back to your networking hub</p>
          </div>
          <SignIn
            appearance={{
              variables: {
          ...
          <p className="auth-footer">
            No account yet?{' '}
            <a href="/sign-up">Create your free V.Card →</a>
          </p>
        </div>
      </main>
    </>
