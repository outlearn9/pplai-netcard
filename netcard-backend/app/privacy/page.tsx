...
export const metadata: Metadata = {
  title: 'Privacy Policy — PPL AI',
  description: 'How PPL AI collects, uses, and protects your personal information.',
}
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-ghost-sm {
          font-size: 14px; font-weight: 500; color: var(--t2); background: none;
          border: 1px solid var(--border); border-radius: 9px; padding: 8px 16px;
          text-decoration: none; transition: all 0.15s;
        }
        .btn-ghost-sm:hover { color: var(--t1); border-color: var(--border-s); background: #EDECE9; }
        .btn-cta {
          font-size: 14px; font-weight: 600; color: #fff; background: var(--indigo);
        ...
        .info-box { background: var(--indigo-light); border: 1px solid var(--indigo-mid); border-radius: 14px; padding: 18px 22px; margin: 32px 0; }
        .info-box p { color: var(--indigo); font-size: 14px; font-weight: 500; margin: 0; }
      ...
      <main className="page">
        ...
        <div className="info-box">
          <p>PPL AI is committed to protecting your privacy. We collect only the data needed to run the service and never sell your personal information to third parties.</p>
        </div>

        <div className="prose">
          <h2>1. Information We Collect</h2>
          <h3>Account Information</h3>
          <p>When you create a PPL AI account, we collect your name, email address, and authentication credentials via our identity provider (Clerk). You may optionally provide a profile photo, job title, company name, phone number, LinkedIn URL, and website.</p>

          <h3>V.Card Data</h3>
          <p>Your digital V.Card contains contact information you explicitly add: name, title, company, email, phone, WhatsApp, LinkedIn, and website. This data is stored so others can view and save your card when you share the link or QR code.</p>

          <h3>Contacts & Networking Data</h3>
          <p>When you scan or add contacts, we store their details along with any notes, tags, and the event context in which you met them. This data is private and visible only to you.</p>

          <h3>Usage Data</h3>
          <p>We collect standard server logs including IP addresses, browser type, pages visited, and actions taken within the app. This helps us diagnose issues and improve the product.</p>

          <h2>2. How We Use Your Information</h2>
          <ul>
            <li><strong>To provide the service</strong> — displaying your V.Card, generating AI follow-up suggestions, and managing your contacts and events.</li>
            <li><strong>To communicate with you</strong> — sending transactional emails (account confirmations, security alerts) and, with your consent, product updates.</li>
            <li><strong>To improve the product</strong> — analysing aggregated, anonymised usage patterns to make PPL AI better.</li>
            <li><strong>To prevent abuse</strong> — detecting spam, fraud, and security threats.</li>
          </ul>

          <h2>3. AI Features</h2>
          <p>PPL AI uses a third-party AI provider (OpenRouter) to generate follow-up message suggestions. Contact names and event context are sent to this service to produce suggestions. We do not use your data to train external AI models. All AI requests are processed in real time and not stored by the AI provider beyond the session.</p>

          <h2>4. Data Sharing</h2>
          <p>We do not sell your personal data. We share data only with:</p>
          <ul>
            <li><strong>Supabase</strong> — our database and storage provider, hosted on AWS.</li>
            <li><strong>Clerk</strong> — our authentication provider.</li>
            <li><strong>OpenRouter</strong> — for AI-generated follow-up suggestions (contact context only, no full profiles).</li>
            <li><strong>Upstash</strong> — for rate limiting (IP addresses only).</li>
            <li><strong>Law enforcement</strong> — only when required by a valid legal order.</li>
          </ul>

          <h2>5. Data Retention</h2>
          <p>We retain your data for as long as your account is active. You may delete your account at any time from the Settings screen, which permanently removes all your data within 30 days. Backups may retain data for up to 90 days after deletion.</p>
          ...
          <ul>
            ...
            <li>Export your data in a portable format (V.Card / CSV)</li>
          </ul>
          <p>To exercise any of these rights, contact us at <a href="mailto:privacy@pplai.app">privacy@pplai.app</a> or use the <a href="/support">support form</a>.</p>

          <h2>7. Cookies</h2>
          <p>We use strictly necessary cookies to keep you signed in (session tokens managed by Clerk). We do not use advertising or tracking cookies. No third-party analytics scripts are loaded on your pages.</p>

          <h2>8. Security</h2>
          <p>All data is encrypted in transit (TLS 1.2+) and at rest. Access to production databases is restricted to authorised personnel via MFA-protected credentials. We conduct periodic security reviews of our infrastructure.</p>

          <h2>9. Children</h2>
          <p>PPL AI is not directed to children under 16. If we become aware that a child under 16 has provided personal data, we will delete it promptly. Please contact us at <a href="mailto:privacy@pplai.app">privacy@pplai.app</a> if you believe this has occurred.</p>

          <h2>10. Changes to This Policy</h2>
          <p>We may update this Privacy Policy from time to time. We will notify you of material changes by email or via an in-app notice at least 14 days before the change takes effect. Your continued use of PPL AI after the effective date constitutes acceptance of the updated policy.</p>

          <h2>11. Contact</h2>
          <p>For privacy-related questions, contact us at <a href="mailto:privacy@pplai.app">privacy@pplai.app</a> or through our <a href="/support">Support page</a>.</p>
        </div>
      </main>
      ...
      <footer className="footer">
        ...
        <ul className="footer-links">
          <li><a href="/privacy" style={{ color: 'var(--indigo)', fontWeight: 600 }}>Privacy</a></li>
